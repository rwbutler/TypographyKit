...
public extension UILabel {
    ...
    public func attributedText(_ text: NSAttributedString?, style: UIFontTextStyle, letterCase: LetterCase = .regular, textColor: UIColor? = nil) {
        ...
        if let text = text {
            ...
            mutableText.enumerateAttributes(in: NSMakeRange(0, text.string.characters.count), options: [], using: { value, range, stop in
